...
하네스시드는 기준을 한 덩어리로 덮어쓰지 않습니다. 회사 공통, 스택, 프로젝트, 개인 기준을 계층으로 보고 충돌을 드러낸 뒤 하나의 작업 맥락으로 정리합니다.
...
개인 기준은 작업 편의를 돕는 보조 기준입니다. 프로젝트 기준, 스택 기준, 회사 공통 기준을 무시하는 근거가 될 수 없습니다.
...
2. 스택 기준을 따르되 프로젝트 예외를 문서화한다.
3. 개인 기준을 제거하거나 개인 로컬 파일에만 남긴다.
4. 판단을 미루고 `developer-input-queue.md`에 질문으로 남긴다.
